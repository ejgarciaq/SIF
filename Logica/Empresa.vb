Public Class Empresa
    ...
    Function VerificarEmpresa(Empresa As String)
        sql = "SELECT * FROM Empresas_table WHERE EMP_IDEMPRESA = '" & Empresa & "'"
    ...
    Function ConsultaEmpresa()
        sql = "SELECT *  FROM Empresas_table"
    ...
    Function IngresarEmpresa(id As String, rol As String, nombre As String, intentos As String, pass As String, cambio As Boolean)
        sql = "INSERT INTO Empresas_table VALUES ('" & id & "','" & rol & "','" & nombre & "','" & intentos & "','" & pass & "'," & cambio & ")"
